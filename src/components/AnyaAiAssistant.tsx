...
const answerEntries: AnswerEntry[] = [
  ...
  },
  {
    ...
    shortLabel: 'ギャップ予想',
    answer:
      '週末ギャップ予想は、GOLD・USDJPY・BTCなどの週末の値動き方向をあらかじめ予想し、週明けに答え合わせするゲームです。予想を記録しておくと、自分の相場観のクセを振り返れます。',
    href: '#/tools/gap-prediction',
    cta: 'ギャップ予想を見る',
    keywords: ['ギャップ', '予想', '週末', 'gold', 'usdjpy', 'btc', 'ゲーム'],
  },
  {
    title: '60秒ハイローについて',
    shortLabel: '60秒ハイロー',
    answer:
      '60秒ハイローは、BTC・GOLDのリアルタイム価格が60秒後に上がるか下がるかを予想するミニゲームです。連勝するとスコア倍率が上がります。実際の売買ではなく、値動きの感覚を鍛える練習用コンテンツです。',
    href: '#/tools/highlow-sprint',
    cta: 'ハイローで遊ぶ',
    keywords: ['ハイロー', '60秒', 'btc', 'gold', 'ゲーム', '予想'],
  },
  {
    title: 'ローソク足スワイプ道場について',
    shortLabel: 'スワイプ道場',
    answer:
      'ローソク足スワイプ道場は、実際の過去チャートの続きを右（上がる）・左（下がる）スワイプで即断するトレーニングゲームです。連続正解でハイスコアを狙えます。',
    href: '#/tools/candle-swipe',
    cta: 'スワイプ道場を見る',
    keywords: ['スワイプ', 'ローソク足', 'チャート', 'ゲーム', 'トレーニング'],
  },
  {
    title: 'トレードタロットについて',
    shortLabel: 'トレードタロット',
    answer:
      'トレードタロットは、相場の迷いをカードに尋ねる占いコンテンツです。トレーダー版の大アルカナ・小アルカナ全78枚から、正位置・逆位置に応じた戒めが表示されます。今日の一枚を見ると、今日の相場ミッションも自動で完了になります。',
    href: '#/tools/trade-tarot',
    cta: 'カードに尋ねる',
    keywords: ['タロット', '占い', 'カード', '今日の一枚', '戒め'],
  },
  {
    title: '今日の相場ミッションについて',
    shortLabel: '今日のミッション',
    answer:
      '今日の相場ミッションは、相場ボード・通貨強弱・経済指標・窓開け監視・振り返り・トレードタロットの確認を、毎日のルーティンとして管理できる機能です。Discordログインすると専用の記録として保存されます。',
    href: '#/tools/daily-mission',
    cta: '今日のミッションを見る',
    keywords: ['ミッション', '今日の', 'ルーティン', '習慣', 'チェック'],
  },
  {
    title: 'マイページについて',
    shortLabel: 'マイページ',
    answer:
      'マイページでは、Discordログイン状態、今日のミッション進捗、週末ギャップ予想、プレミアム導線をまとめて確認できます。ログイン後のホーム的な位置づけです。',
    href: '#/tools/member-dashboard',
    cta: 'マイページを見る',
    keywords: ['マイページ', 'ダッシュボード', 'ログイン後', '進捗'],
  },
];
