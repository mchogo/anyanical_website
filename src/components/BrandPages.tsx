...
const copyTradeNoticeItems = [
  ...
  {
    title: '損切り・ドローダウンについて',
    badge: 'Mindset',
    body: '運用中は損切りが発生することもあります。ご自身の判断でより早めに損切りしたい場合は、各自で調整いただいて問題ありません。配信者よりトレードの判断に自信がある方は、コピーを使わず手動で判断していただいても構いません。一方で、多少のドローダウンのたびに不安になってしまう方は、コピートレード自体があまり向いていない可能性があります。ご自身のリスク許容度を踏まえたうえで、無理のない範囲でご検討ください。',
  },
  {
    title: '短期的な損益について',
    badge: 'Mindset',
    body: '日単位の利益を保証するものではなく、長期的に見てプラスになることを目指した運用です。1日単位、まして数時間単位の細かな損益に一喜一憂してしまう方には、あまり向いていない可能性があります。長い目で見て判断してください。',
  },
];
